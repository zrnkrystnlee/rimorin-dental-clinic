                            ...
                            <div className="card patient-info">
                                <div className="card-body pt-3">
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="col-lg-3 col-md-6 label">House No. & Street Name</div>
                                            <div id="houseno" class="col-lg-3 col-sm-6">#10 Cirineo Subdivision</div>
                                    </div>

                                    <div class="row">
                                            <div class="col-lg-3 col-md-12 label">Municipality/City</div>
