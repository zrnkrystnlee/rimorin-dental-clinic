          ...
          <div className="col-12">
            <div className="card recent-sales overflow-auto">
              ...
              <div className="card-body">
                ...
                {/* <table id="MyTable" className="table table-borderless datatable">
                  <thead>
                    <tr>
...
<table className="table">
    ...
    <tbody>
      ...
      <tr><td>Brennan Brooks</td><td>9011</td><td>Olmué</td><td>2000/18/04</td><td>2%</td></tr>
      ...
      <tr><td>Elaine Bishop</td><td>9160</td><td>Petrópolis</td><td>2008/23/12</td><td>48%</td></tr>
